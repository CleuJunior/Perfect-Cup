                    ...
                    <form role="form">
                        <div class="row">
                            <div class="form-group col-lg-4">
                                ...
                                <input type="text" id="fname" name="fname" class="form-control" maxlength="25">
                            </div>
                            <div class="form-group col-lg-4">
                                <label>Last Name</label>
                                <input type="text" id="lname" name="lname" class="form-control" maxlength="25">
                            </div>
                            <div class="form-group col-lg-4">
                            ...
                            <div class="form-group col-lg-12">
                                ...
                                <input type="password" id="password" name="passwrod" class="form-control" maxlength="10">
                            </div>
                            <div class="form-group col-lg-12">
